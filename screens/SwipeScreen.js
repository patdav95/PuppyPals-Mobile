...
import { Platform, StyleSheet, Image, View,Alert, Text,ScrollView,
        Dimensions, Animated, PanResponder,TouchableOpacity} from 'react-native';
...
updateCards = (userID) => {
  this._getCards(userID);
  this.state.No_More_Card = false;
  //this.forceUpdate();
}
    ...
    return (
      ...
      <View style={styles.MainContainer}>
        ...
        {this.state.No_More_Card ? (
          <TouchableOpacity onPress={() => this.updateCards(this.state.userInfo.userID)}
